...
namespace Build
{
    static class Program
    {
        static Task Main(string[] args)
        {
            ...
            {
                RunShell($"dotnet run --project generator/src/Blog/Blog.csproj build -o {output}");
            });
            
            Target("serve", () =>
            {
                RunShell("dotnet run --project generator/src/Blog/Blog.csproj serve");
            });
            ...
            Target("deploy", DependsOn("deploy-clean"), () =>
            {
                ...
                RunShell($"git clone git@github.com:pauldotknopf/pauldotknopf.github.io.git {tmpRepo}");
